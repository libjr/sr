        ...
        if(!empty($tmdb)){
            ...
            if(isset($tmdb)){
                ...
                if(!$this->VeryTMDb($skey,$tmdb,'movies') || $this->repeatd == true){
                    ...
                    $tmdb_upimage        = isset($tmdb_poster_path) ? DBMOVIES_TMDBIMG.'/t/p/w780'.$tmdb_poster_path : false;
        ...
        if($tmdb && $season && $episode && $name){
            ...
            if(!$this->VeryTMDbEP($tmdb, $season, $episode) || $this->repeatd == true){
                ...
                if(!$this->Disset($json_tmdb,'status_code')){
                    ...
                    $tmdb_upimage        = isset($tmdb_still_path) ? DBMOVIES_TMDBIMG.'/t/p/w500'.$tmdb_still_path : false;
                    // Compose Images
                    $images = '';
                    if($tmdb_images){
                        $image_count = 0;
